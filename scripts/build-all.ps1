...
$baseline = Join-Path $artifacts 'AudioSourceMixer-0.2.2-win-x64-setup.exe'
...
try {
    ...
    Write-Output "The v$(Get-ProductVersion) installer and verification manifest are under $artifacts."
